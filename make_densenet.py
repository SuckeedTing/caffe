...
def densenet(data_file, mode='train', batch_size=64, depth=40, first_output=16, growth_rate=12, dropout=0.2):
    data, label = L.Data(source=data_file, backend=P.Data.LMDB, batch_size=batch_size, ntop=2, 
              transform_param=dict(mean_file="/home/sjxy/densenetcaffe/examples/cifar10/mean.binaryproto"))
...
def make_net():
    ...
    with open('train_densenet.prototxt', 'w') as f:
        ...
        print(str(densenet('/home/sjxy/densenetcaffe/examples/cifar10/cifar10_train_lmdb', batch_size=64)), file=f)

    with open('test_densenet.prototxt', 'w') as f:
        print(str(densenet('/home/sjxy/densenetcaffe/examples/cifar10/cifar10_test_lmdb', batch_size=50)), file=f)
